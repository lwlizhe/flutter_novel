...
class PowerScrollable extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const PowerScrollable({
    Key? key,
  ...
  @override
  PowerScrollableState createState() => PowerScrollableState();
  ...
  static PowerScrollableState? of(BuildContext context) {
  ...
  static Future<void> ensureVisible(
    ...
    PowerScrollableState? scrollable = PowerScrollable.of(context);
    while (scrollable != null) {
      ...
      scrollable = PowerScrollable.of(context);
    }
...
class PowerScrollableState extends State<PowerScrollable>
  ...
  bool _shouldUpdatePosition(PowerScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(PowerScrollable oldWidget) {
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  bool isEnabled(ScrollIntent intent) {
    ...
    if (contextIsValid) {
      ...
      if (PowerScrollable.of(focus.context!) != null) return true;
      ...
      if (PrimaryScrollController.of(focus.context!) != null) {
        ...
        return primaryScrollController != null &&
            ...
            primaryScrollController.position.context.notificationContext !=
                null &&
            PowerScrollable.of(primaryScrollController
  ...
  double _getIncrement(PowerScrollableState state, ScrollIntent intent) {
  ...
  void invoke(ScrollIntent intent) {
    PowerScrollableState? state = PowerScrollable.of(primaryFocus!.context!);
    if (state == null) {
      final ScrollController? primaryScrollController =
          PrimaryScrollController.of(primaryFocus!.context!);
      state = PowerScrollable.of(
          primaryScrollController!.position.context.notificationContext!);
    }
    assert(state != null,
